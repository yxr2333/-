...
Page({
  ...
  check:function(){
    if(this.data.res == 100 && app.globalData.cnt1 >= 0 && app.globalData.cnt2 >= 0 && app.globalData.cnt3 >= 0){
      if(app.globalData.cnt < 2700){
        app.globalData.res = app.globalData.cnt * 4.01471 - 1739.70588
      }else{
        app.globalData.res = app.globalData.cnt * -0.04676 + 9226.25899
      }
      app.globalData.res  = app.globalData.res * (1-(Math.abs(app.globalData.cnt1 - 70) + Math.abs(app.globalData.cnt2 - 30) + Math.abs(app.globalData.cnt3)) / 300);
      app.globalData.cnt1 = 0
      app.globalData.cnt2 = 0
      app.globalData.cnt3 = 0
