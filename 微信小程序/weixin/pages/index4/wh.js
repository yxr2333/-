...
Page({
  ...
  check:function(){
    if(this.data.res == 100 && app.globalData.cnt1 >= 0 && app.globalData.cnt2 >= 0 && app.globalData.cnt3 >= 0){
      if(app.globalData.cnt < 13000){
        app.globalData.res = app.globalData.cnt * 1.33581 + 4007.4375
      }else{
        app.globalData.res = app.globalData.cnt * -0.12283 + 22969.83333
      }
      app.globalData.res  = app.globalData.res * (1-(Math.abs(app.globalData.cnt1 - 60) + Math.abs(app.globalData.cnt2 - 40) + Math.abs(app.globalData.cnt3)) / 300);
      app.globalData.cnt1 = 0
      app.globalData.cnt2 = 0
      app.globalData.cnt3 = 0
