...
Page({
  ...
  check:function(){
    if(this.data.res == 100 && app.globalData.cnt1 >= 0 && app.globalData.cnt2 >= 0 && app.globalData.cnt3 >= 0){
        if(app.globalData.cnt < 2000){
          app.globalData.res = app.globalData.cnt * 7.02825 - 4685.5
        }else{
          app.globalData.res = app.globalData.cnt * -0.04781 + 9466.62245
        }
      app.globalData.res  = app.globalData.res * (1-(Math.abs(app.globalData.cnt1 - 100) + Math.abs(app.globalData.cnt2) + Math.abs(app.globalData.cnt3)) / 300);
      app.globalData.cnt1 = 0
      app.globalData.cnt2 = 0
      app.globalData.cnt3 = 0
